...
public class Kvadar extends GeometrijskoTelo{
    ...
    public void setDuzina(double duzina) {
        if (duzina > 0)
            ...
            System.out.println("Greska! Duzina strani mora biti veca od nule.");
    }
    ...
    public void setSirina(double sirina) {
        if (sirina > 0)
            ...
            System.out.println("Greska! Sirina strani mora biti veca od nule.");
    }
    ...
    public void setVisina(double visina) {
        if (visina > 0)
            ...
            System.out.println("Greska!Visina mora biti veca od nule.");
    }
